---
--
local on_restricted_return = require('src.observers.events.chat_member.restricted_return')
local on_member_left = require('src.observers.events.chat_member.member_left')
local on_new_member = require('src.observers.events.chat_member.new_member')
local on_admin_demoted = require('src.observers.events.chat_member.admin_demoted')
local on_admin_promoted = require('src.observers.events.chat_member.admin_promoted')
local on_member_kicked = require('src.observers.events.chat_member.member_kicked')
local on_member_unbanned = require('src.observers.events.chat_member.member_unbanned')
local on_admin_left = require('src.observers.events.chat_member.admin_left')
local on_owner_left = require('src.observers.events.chat_member.owner_left')

local event_chat_member = require('src.enums.event_chat_member')
local observer = require('bot.classes.Observer')
